    ...
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            var config = new Dictionary<string, object> {
                ...
                { "ssl.ca.location", @"C:\Kafka\secrets\snakeoil-ca-1.crt" },
                { "ssl.certificate.location", @"C:\Kafka\secrets\MyClient1.crt" },
                { "ssl.key.location", @"C:\Kafka\secrets\MyClient1.key" },
             //   { "ssl.key.password", "ssl" },
            };
